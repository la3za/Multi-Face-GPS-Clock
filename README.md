...
The purpose of this clock is to make available as many clock and clock related functions as possible give the constraint of a 20 x 4 LCD. The number of different screens are now more than twenty. Some are useful, some are very specialized, and some are somewhat weird. All the screens have been laid out with a view to good esthetics and easy readability.
